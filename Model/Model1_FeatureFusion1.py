...
class FeatureFusion1(nn.Module):
    def __init__(self, decoder_in_channels, encoder_in_channels):
        ...
        #
        self.decoder_conv = nn.Conv2d(in_channels=decoder_in_channels, out_channels=encoder_in_channels, kernel_size=1,
                                      stride=1, padding=0, bias=False)
        self.decoder_conv_bn = nn.BatchNorm2d(num_features=encoder_in_channels)
        #
        self.encoder_conv = nn.Conv2d(in_channels=encoder_in_channels, out_channels=encoder_in_channels, kernel_size=1,
                                      stride=1, padding=0, bias=False)
...
class Model1(nn.Module):  # Total params: 837,014
    def __init__(self):
        ...
        # decoder 1
        self.upsample1 = UpsampleBlock(in_channels=128, out_channels=128)
        ...
        # decoder 2
        self.upsample2 = UpsampleBlock(in_channels=64, out_channels=64)
